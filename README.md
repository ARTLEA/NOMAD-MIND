...
<head>
  ...
  <style>
    ...
    .section li { margin: 0.7rem 0; line-height: 1.6; display: flex; align-items: flex-start; }
    .section li::before { content: "✓"; margin-left: 0.5rem; color: #00ccaa; font-weight: bold; }
  ...
  <!-- ===== MailerLite embed styles (as provided) ===== -->
  <style type="text/css">
    /* LOADER */
...
<p style="color:#cc0000; font-weight:bold; font-size:1.1rem; margin-top:0.5rem;">سجل الآن واحصل على شهر مجاني! المقاعد محدودة لأول المشتركين.</p>
  ...
  <script>fetch("https://assets.mailerlite.com/jsonp/1660733/forms/160032468464829657/takel")</script>
</body>
</html>
